...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dv-job.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DVJOB_LIST actions', async () => {
    ...
    it('dispatches FETCH_DVJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DVJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DVJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DVJOB actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DVJOB actions', async () => {
      const expectedActions = [
        {
