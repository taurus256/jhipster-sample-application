...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dv-user.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DVUSER_LIST actions', async () => {
    ...
    it('dispatches FETCH_DVUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DVUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DVUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DVUSER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DVUSER actions', async () => {
      const expectedActions = [
        {
