...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dv-task.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DVTASK_LIST actions', async () => {
    ...
    it('dispatches FETCH_DVTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DVTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DVTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DVTASK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DVTASK actions', async () => {
      const expectedActions = [
        {
